...
CREATE TABLE `codir_user_profil`
(
...
insert into codir_users(login,password,fullname) values('user001','pass','USER 001');
insert into codir_users(login,password,fullname) values('user002','pass','USER 002');
insert into codir_users(login,password,fullname) values('user003','pass','USER 003');
insert into codir_users(login,password,fullname) values('user004','pass','USER 004');
insert into codir_users(login,password,fullname) values('user005','pass','USER 005');
insert into codir_users(login,password,fullname) values('user006','pass','USER 006');
insert into codir_users(login,password,fullname) values('user007','pass','USER 007');
insert into codir_users(login,password,fullname) values('user008','pass','USER 008');
insert into codir_users(login,password,fullname) values('user009','pass','USER 009');
insert into codir_users(login,password,fullname) values('user010','pass','USER 010');
insert into codir_users(login,password,fullname) values('user011','pass','USER 011');
insert into codir_users(login,password,fullname) values('user012','pass','USER 012');
insert into codir_users(login,password,fullname) values('user013','pass','USER 013');
insert into codir_users(login,password,fullname) values('user014','pass','USER 014');
insert into codir_users(login,password,fullname) values('user015','pass','USER 015');
insert into codir_users(login,password,fullname) values('user016','pass','USER 016');
insert into codir_users(login,password,fullname) values('user017','pass','USER 017');
-- ************************************** `categories`
...
-- ************************************** `truck_visit`
CREATE TABLE IF NOT EXISTS `truck_visit`
(
...
-- ************************************** `truck_controllers`
CREATE TABLE `truck_controllers`
(
...
CREATE TABLE `stl_operated_truck_visit`
(
 `id`    integer NOT NULL PRIMARY KEY AUTOINCREMENT ,
 `visit_date`               date NOT NULL ,
 `visit_time`               time NOT NULL ,
...
(
 ...
 `semitrailer_registration` varchar(15) NOT NULL ,
 `driver_name`              varchar(200) NOT NULL ,
 `tractor_mileage`          number NOT NULL ,
 `remarks`                  text NULL ,
 `vehicle_accepted`         tinyint NULL ,
 `inspector_visa`           blob NULL ,
 `driver_visa`              blob NULL ,
...
CREATE TABLE `hse_construction_visit`
(
 `id`    integer NOT NULL PRIMARY KEY AUTOINCREMENT ,
 `visit_date`                date NOT NULL ,
...
----------------------------- BOTTLES ---------------------------------
--etat general 
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,147,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,148,"N");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,149,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,150,"N*");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,151,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,152,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,153,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,154,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,155,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,156,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,157,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,35,null,158,"N");
-- equipement du vehicule
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,36,null,159,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,36,null,160,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,36,null,161,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,36,null,162,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,36,null,163,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,36,null,164,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,36,null,165,"O");
-- chauffeur
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,37,null,166,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(5,37,null,167,"O");

----------------- STL OPERATED TRUCK ----------------
-- control commmun
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,147,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,166,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,148,"N");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,149,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,150,"N*");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,163,"N**");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,167,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,152,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,153,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,154,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,156,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,165,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,168,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,158,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,157,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,164,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,38,null,155,"O");

-- hydrocarbures , lubrifiants .... 

insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,39,null,171,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,39,null,172,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,39,null,173,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,39,null,174,"O");

-- semi et porteur de gaz vrac 
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,40,null,175,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,40,null,176,"O");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,40,null,177,"N***");
insert into question_category_subcategory(item_id,category_id,subcategory_id,question_id,blocking_point) values(6,40,null,178,"O");

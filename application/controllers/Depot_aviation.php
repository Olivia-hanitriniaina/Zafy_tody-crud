...
class Depot_aviation extends CI_Controller{
   ...
   public function loadRecord($rowno=0){
        ...
        $allcount=$this->Depot_model->get_count();

        $depot_aviation=$this->Depot_model->get_all_depots($rowPerPage,$rowno);

        $config['base_url'] = base_url().'depot_aviation/loadRecord';
   ...
   public function store(){
       $data=array(
            'nom'=>$this->input->post('depot_aviation'),
   ...
   public function get_rechercher(){
        ...
        $data=$this->Depot_model->search_depot($depots,$gerant);

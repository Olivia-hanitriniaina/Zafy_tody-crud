            ...
            <?php if($depots): ?>
                <?php foreach($depots as $depot): ?>
                    <tr id="depot_id_<?=$depot->id;?>">
                        <td style="text-align:center"><?= $depot->id ?></td>
                        <td style="text-align:center"><?= $depot->name?></td>
                        <td style="text-align:center"><?= $depot->fullname ?></td>
                        
                        <td style="text-align:center">
                            <a href="javascript:void(0)" id="edit-depot" data-id="<?=$depot->id?>" class="btn btn-info"> <i class="fa fa-edit"></i> Modifier</a>
                            <a href="javascript:void(0)" id="delete-depot" data-id="<?=$depot->id?>" class="btn btn-danger delete-user"> <i class="fa fa-trash"></i> Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach;?>
            <?php endif;?>        
           ...
           $.ajax({
               ...
               success: function (res){
                    if(res.success == true){
                        ...
                        $('#depot_aviation').val(res.data.name);
       ...
       $('#depotForm').validate({
           submitHandler: function(form){
               ...
               $.ajax({
                   ...
                   success: function(res){
                    var depot='<tr id="depot_id_'+ res.data.id + '"><td>' + res.data.id + '</td><td>'+res.data.name+'</td><td>' + res.data.fullname + '</td><td>';

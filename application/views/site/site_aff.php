        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="siteCrudModal" style="text-align:center"></h4>
                </div>
...
<script>
   var SITEURL='<?php echo base_url();?>';
    ...
    /** Quand on crée ou met à jour un élément */
   if($('#siteForm').length >0){
       $('#siteForm').validate({
            ...
            messages:{
                nom_site:{
                    required:"Veuillez remplir le champ par le nom du site",
                },
                local_manager:{
                    required:"Veuillez selectionner un Chef de site",
                }
            },
           submitHandler: function(form){
               ...
               $.ajax({
                   ...
                   success: function(res){
                    var site='<tr id="site_id_'+ res.data.id + '"><td>' + res.data.id + '</td><td>' + res.data.nom + '</td><td>'+ res.data.nom_complet + '</td><td>'; 
                  ...
                  error:function(data){
                    console.log('error:',data);
                    $('#btn-save').html('Enregister');  
                    $('#siteCrudModal').html('Internal Server Error');  
                  }
               });
           }
       })

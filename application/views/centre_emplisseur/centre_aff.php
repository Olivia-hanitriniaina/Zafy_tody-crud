        ...
        <tbody>
            <?php if($centres): ?>
                <?php foreach($centres as $centre): ?>
                    <tr id="centre_id_<?=$centre->id;?>">
                        <td style="text-align:center"><?= $centre->id ?></td>
                        <td style="text-align:center"><?= $centre->name ?></td>
                        <td style="text-align:center"><?= $centre->fullname ?></td>
                        <td style="text-align:center">
                            <a href="javascript:void(0)" id="edit-centre" data-id="<?=$centre->id?>" class="btn btn-info"> <i class="fa fa-edit"></i> Modifier</a>
                            <a href="javascript:void(0)" id="delete-centre" data-id="<?=$centre->id?>" class="btn btn-danger delete-user"> <i class="fa fa-trash"></i> Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach;?>
            <?php endif;?>        
